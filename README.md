...
⚠️ This package is **abandoned** and no longer maintained. The author suggests using the **[rinvex/laravel-attributes](https://github.com/rinvex/laravel-attributes)** package instead. ⚠️
